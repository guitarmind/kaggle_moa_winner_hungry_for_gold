...
parser = argparse.ArgumentParser(description='Inferencing DeepInsight EfficientNet B3 NS')
...
submission.to_csv(f'{output_folder}/submission_effnet_v7_b3.csv', index=False)
